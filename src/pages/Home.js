  ...
  if(onNovaObservacao)
    {
      return(
        <>
          <CriarObservacao objetoId={selectedObjeto.objetoId} usuarioId={selectedObjeto.usuarioId} backToHome={() => handleHome()}  />
        </>
      )
    }
  ...
  if ( onDetails)
    {
      return(
        <>
          <Detalhes objeto={selectedObjeto} setOnDetails={setOnDetails} onNovaObs={() => handleNovaObservacao()} />
        </>
      )
    }
  return (
